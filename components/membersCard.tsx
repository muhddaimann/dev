  ...
  return (
    <View style={styles.wrapper}>
      <Card style={[styles.card, { backgroundColor: theme.colors.primaryContainer, shadowColor: theme.colors.shadow }]}>
        <Card.Content>
          <Title style={[styles.title, { color: theme.colors.onPrimaryContainer }]}>Members</Title>
          <Paragraph style={[styles.text, { color: theme.colors.onPrimaryContainer }]}>245 Active</Paragraph>
        </Card.Content>
      </Card>
    </View>
  );
